...
export const metadata = {
  ...
  description: 'Your personal AI-powered coaching platform',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="h-full">
      <body className={`${inter.className} min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800`}>
        <Providers>
